...
//informaçao pessoal
router.post('/infPessoal', //isLoggedIn, 
async (req,res,next) => {
...
//vestimenta
router.post('/vestimenta', //isLoggedIn , 
async (req,res,next) => {
...
//alterar password
router.post('/altPass', //isLoggedIn , 
async (req,res,next) => {
...
router.post('/altFoto', //isLoggedIn , 
